...
fallback_words = {
 ...
 'spit', 'tarp', 'unto', 'wage'],
    ...
    "scratch", "tarnish", "utopia", "vagrant", "waffles",  "zippers", "attract",
    "boycott", "combine", "dominate", "earnest", "fortune", "garland", "habitat", "iterate",
    ...
    "majesty", "musical", "obliged", "patient", "queries", "radical", "scenery", "therapy", 
